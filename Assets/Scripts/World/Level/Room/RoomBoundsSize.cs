...
public class RoomBoundsSize : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //+9pthis.transform.localScale = new Vector3(this.transform.localScale.x-this.transform.localScale.x % 30, this.transform.localScale.y-this.transform.localScale.y % 16.875f);
